package vn.edu.vnu.ifi.promo22bank.presentation;
...
import vn.edu.vnu.ifi.promo22bank.presentation.vues.Accueil;
...
public class Login {
	...
	private void initialize() {
		...
		JLabel lblBienvenueDansCheckme = new JLabel("BIENVENUE DANS Promo22Bank");
		...
		JLabel lblNewLabel_1 = new JLabel("Application de gestion d'une banque de proximit\u00E9");
